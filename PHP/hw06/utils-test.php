...
test(dropdown("Two", array("first" => "this",
     ...
     . "      </select>\n");
test(dropdown("TwoB", array("first" => "this",
                           "second" => "that"), "second"), 
     "<select name='TwoB'>\n"
     . "        <option value = 'first'>this</option>\n"
     . "        <option value = 'second' selected='selected' >that</option>\n"
     . "      </select>\n");
...
test(checkbox("Two", array("First" => "this",
                           "Second" => "that"), array("Second" => "that")), 
     "<label><input type='checkbox' name='Two[]' value='this' />First</label><br>\n"
     . "      <label><input type='checkbox' name='Two[]' value='that' checked='checked' />Second</label><br>");
