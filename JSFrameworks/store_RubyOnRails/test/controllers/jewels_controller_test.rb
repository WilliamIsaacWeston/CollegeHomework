...
class JewelsControllerTest < ActionController::TestCase
  ...
  test "should create jewel" do
    assert_difference('Jewel.count') do
      post :create, jewel: { collection_id: @jewel.collection_id, description: @jewel.description, name: @jewel.name, price: @jewel.price, quantity: @jewel.quantity }
    end
  ...
  test "should update jewel" do
    patch :update, id: @jewel, jewel: { collection_id: @jewel.collection_id, description: @jewel.description, name: @jewel.name, price: @jewel.price, quantity: @jewel.quantity }
    assert_redirected_to jewel_path(assigns(:jewel))
  end
